...
const SingleExpense = () => {
    return (
        <div
            className="w-full bg-white rounded-lg border border-slate-100 shadow-md flex gap-3 items-center justify-between p-5 py-6">
            {/*Wallet Icon*/}
            ...
            <div className="flex gap-11 font-bold items-center">
                ...
                <div className="flex gap-2 items-center">
                    {/*Edit Button*/}
                    <div
                        className="rounded-lg flex items-center justify-center cursor-pointer bg-green-200 hover:bg-green-300">
